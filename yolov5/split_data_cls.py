...
def main():
    src_data_path = r'D:\MyData\data_flydetection\chejian_demo\chejian_luoshuan\voc_cls_chejian_luoshuan_data'
    target_data_path = r'D:\MyData\data_flydetection\chejian_demo\chejian_luoshuan\yolo_cls_chejian_luoshuan_data'
    split_data(src_data_path, target_data_path, train_rate=0.9)


if __name__ == '__main__':
    # 该程序是将分类数据按比例划分，分类数据的格式是一个类别一个文件夹
    main()